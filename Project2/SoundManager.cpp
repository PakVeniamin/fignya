...
SoundManager::SoundManager()
{
	...
	m_FireBuffer.loadFromFile("Sounds/LavaSound.wav");
	m_FallInFireBuffer.loadFromFile("Sounds/FallInLava.wav");
	m_FallInWaterBuffer.loadFromFile("Sounds/WaterDamage.wav");
	m_JumpBuffer.loadFromFile("Sounds/jump.wav");
	m_ReachGoalBuffer.loadFromFile("Sounds/LevelFinished.wav");
	...
	// When the player is 50 pixels away Sounds is full volume
